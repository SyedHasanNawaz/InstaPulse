      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
        ...
        <div className="flex-1 w-full min-h-[600px]">
          <AnimatePresence mode="wait">
            ...
            >
              {activeSection === 'account' && <AccountSettings onSave={handleSave} />}
...
const AccountSettings = ({ onSave }: any) => (
    ...
    <section className="bg-white dark:bg-zinc-900 rounded-[32px] border border-slate-100 dark:border-zinc-800 shadow-sm overflow-hidden transition-colors">
      ...
      <div className="p-8 space-y-8">
        <div className="flex items-center space-x-6">
          <div className="w-20 h-20 rounded-full bg-slate-100 dark:bg-zinc-800 flex items-center justify-center border-2 border-slate-200 dark:border-zinc-700 shrink-0">
            <User size={32} className="text-slate-400 dark:text-zinc-500" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <SettingsInput label="Username" placeholder="your_account" icon={User} />
          <SettingsInput label="Email Address" placeholder="hello@instapulse.ai" icon={Mail} />
  ...
  <div className="space-y-8">
    <section className="bg-white dark:bg-zinc-900 rounded-[32px] border border-slate-100 dark:border-zinc-800 shadow-sm overflow-hidden">
      ...
      <div className="p-8 space-y-6">
        <SettingsInput label="Current Password" placeholder="••••••••" icon={Lock} type="password" />
        <SettingsInput label="New Password" placeholder="••••••••" icon={Key} type="password" />
        <SettingsInput label="Confirm New Password" placeholder="••••••••" icon={ShieldCheck} type="password" />
      </div>
    </section>
    <section className="bg-white dark:bg-zinc-900 rounded-[32px] border border-slate-100 dark:border-zinc-800 shadow-sm overflow-hidden">
      <div className="p-8 border-b border-slate-50 dark:border-zinc-800">
...
const SettingsInput = ({ label, placeholder, icon: Icon, type = "text" }: any) => (
  <div className="space-y-2">
